function itsg_gf_wysiwyg_ckeditor_function(self){
	...
	(function( $ ) {
		...
		for ( var key in ckeditor_fields ) {
			...
			console.log( 'gravity-forms-trix :: field_id: ' + field_id );
			...
			$(function(){
				$('.gform_wrapper .gform_trix:not(.wysiwyg_exclude) textarea:not([disabled="disabled"],.wysiwyg_exclude), .gform_wrapper .gform_page:not([style="display:none;"],.wysiwyg_exclude) .gform_trix:not(.wysiwyg_exclude) textarea:not([disabled=disabled],.wysiwyg_exclude), #field_settings textarea:not([disabled=disabled],#gfield_bulk_add_input,#field_calculation_formula,.wysiwyg_exclude,#field_placeholder_textarea), .gf_entry_wrap .postbox .gform_trix:not(.wysiwyg_exclude) textarea:not([disabled=disabled],.wysiwyg_exclude)').each(function() {
